...
/**
 * @file ssd1306_i2c_functions.h
 * @brief Declaração de funções para controle do display OLED SSD1306 via I2C no Raspberry Pi Pico W.
 *
 * Este arquivo contém as declarações das funções utilizadas para a comunicação e controle do
 * display SSD1306, incluindo:
 * - Envio de comandos e dados via I2C.
 * - Manipulação de pixels, linhas e caracteres.
 * - Configuração e inicialização do display.
 * - Suporte a scrolling e exibição de bitmaps.
 *
 * @note Este arquivo está disponível em:
